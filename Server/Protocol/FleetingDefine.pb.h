...
// source: FleetingDefine.proto

#ifndef PROTOBUF_FleetingDefine_2eproto__INCLUDED
#define PROTOBUF_FleetingDefine_2eproto__INCLUDED
...
void LIBPROTOC_EXPORT protobuf_AddDesc_FleetingDefine_2eproto();
void protobuf_AssignDesc_FleetingDefine_2eproto();
void protobuf_ShutdownFile_FleetingDefine_2eproto();
...
class LIBPROTOC_EXPORT FSVector3 : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:FS.FSVector3)
 private:
  ...
  friend void LIBPROTOC_EXPORT protobuf_AddDesc_FleetingDefine_2eproto();
  friend void protobuf_AssignDesc_FleetingDefine_2eproto();
  friend void protobuf_ShutdownFile_FleetingDefine_2eproto();
...
class LIBPROTOC_EXPORT SuwayyahEvents_Suwayyah : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.SuwayyahEvents.ESEType EventType = 1;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 1;
  inline ::FS::SuwayyahEvents_ESEType eventtype() const;
  inline void set_eventtype(::FS::SuwayyahEvents_ESEType value);
  ...
  // @@protoc_insertion_point(class_scope:FS.SuwayyahEvents.Suwayyah)
 private:
...
class LIBPROTOC_EXPORT SuwayyahEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.SuwayyahEvents.Suwayyah xSuwayyahList = 1;
  inline int xsuwayyahlist_size() const;
  inline void clear_xsuwayyahlist();
  static const int kXSuwayyahListFieldNumber = 1;
  inline const ::FS::SuwayyahEvents_Suwayyah& xsuwayyahlist(int index) const;
  inline ::FS::SuwayyahEvents_Suwayyah* mutable_xsuwayyahlist(int index);
  inline ::FS::SuwayyahEvents_Suwayyah* add_xsuwayyahlist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::SuwayyahEvents_Suwayyah >&
      xsuwayyahlist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::SuwayyahEvents_Suwayyah >*
      mutable_xsuwayyahlist();

  // @@protoc_insertion_point(class_scope:FS.SuwayyahEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::SuwayyahEvents_Suwayyah > xsuwayyahlist_;
...
class LIBPROTOC_EXPORT BulletEvents_TacheBomp : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:FS.BulletEvents.TacheBomp)
 private:
...
class LIBPROTOC_EXPORT BulletEvents_Bullet : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.BulletEvents.EBEType EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::BulletEvents_EBEType eventtype() const;
  inline void set_eventtype(::FS::BulletEvents_EBEType value);
  ...
  // required .FS.BulletEvents.EBE_BACKType BulletBackType = 6;
  inline bool has_bulletbacktype() const;
  inline void clear_bulletbacktype();
  static const int kBulletBackTypeFieldNumber = 6;
  inline ::FS::BulletEvents_EBE_BACKType bulletbacktype() const;
  inline void set_bulletbacktype(::FS::BulletEvents_EBE_BACKType value);
  ...
  // required .FS.FSVector3 FireTacheOffest = 12;
  inline bool has_firetacheoffest() const;
  inline void clear_firetacheoffest();
  static const int kFireTacheOffestFieldNumber = 12;
  inline const ::FS::FSVector3& firetacheoffest() const;
  inline ::FS::FSVector3* mutable_firetacheoffest();
  inline ::FS::FSVector3* release_firetacheoffest();
  inline void set_allocated_firetacheoffest(::FS::FSVector3* firetacheoffest);
  ...
  // repeated .FS.BulletEvents.TacheBomp Bomp = 18;
  inline int bomp_size() const;
  inline void clear_bomp();
  static const int kBompFieldNumber = 18;
  inline const ::FS::BulletEvents_TacheBomp& bomp(int index) const;
  inline ::FS::BulletEvents_TacheBomp* mutable_bomp(int index);
  inline ::FS::BulletEvents_TacheBomp* add_bomp();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_TacheBomp >&
      bomp() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_TacheBomp >*
      mutable_bomp();

  // @@protoc_insertion_point(class_scope:FS.BulletEvents.Bullet)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
  ...
  ::FS::FSVector3* firetacheoffest_;
  ::std::string* bulletprefabpath_;
  ::std::string* methodcall_;
  ::std::string* methodparam_;
  ::std::string* targetmethodcall_;
  ::std::string* targetmethodparam_;
  ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_TacheBomp > bomp_;
...
class LIBPROTOC_EXPORT BulletEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.BulletEvents.Bullet xBulletList = 1;
  inline int xbulletlist_size() const;
  inline void clear_xbulletlist();
  static const int kXBulletListFieldNumber = 1;
  inline const ::FS::BulletEvents_Bullet& xbulletlist(int index) const;
  inline ::FS::BulletEvents_Bullet* mutable_xbulletlist(int index);
  inline ::FS::BulletEvents_Bullet* add_xbulletlist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_Bullet >&
      xbulletlist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_Bullet >*
      mutable_xbulletlist();

  // @@protoc_insertion_point(class_scope:FS.BulletEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_Bullet > xbulletlist_;
...
class LIBPROTOC_EXPORT AnimatorMoves_Move : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.AnimatorMoves.EAMType EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::AnimatorMoves_EAMType eventtype() const;
  inline void set_eventtype(::FS::AnimatorMoves_EAMType value);
  ...
  // @@protoc_insertion_point(class_scope:FS.AnimatorMoves.Move)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT AnimatorMoves : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.AnimatorMoves.Move xMoveList = 1;
  inline int xmovelist_size() const;
  inline void clear_xmovelist();
  static const int kXMoveListFieldNumber = 1;
  inline const ::FS::AnimatorMoves_Move& xmovelist(int index) const;
  inline ::FS::AnimatorMoves_Move* mutable_xmovelist(int index);
  inline ::FS::AnimatorMoves_Move* add_xmovelist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::AnimatorMoves_Move >&
      xmovelist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::AnimatorMoves_Move >*
      mutable_xmovelist();

  // @@protoc_insertion_point(class_scope:FS.AnimatorMoves)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::AnimatorMoves_Move > xmovelist_;
...
class LIBPROTOC_EXPORT CameraControlEvents_Camera : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.CameraControlEvents.ECEType EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::CameraControlEvents_ECEType eventtype() const;
  inline void set_eventtype(::FS::CameraControlEvents_ECEType value);

  // required .FS.FSVector3 AmountParam = 3;
  inline bool has_amountparam() const;
  inline void clear_amountparam();
  static const int kAmountParamFieldNumber = 3;
  inline const ::FS::FSVector3& amountparam() const;
  inline ::FS::FSVector3* mutable_amountparam();
  inline ::FS::FSVector3* release_amountparam();
  inline void set_allocated_amountparam(::FS::FSVector3* amountparam);
  ...
  // @@protoc_insertion_point(class_scope:FS.CameraControlEvents.Camera)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT CameraControlEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.CameraControlEvents.Camera xCameraList = 1;
  inline int xcameralist_size() const;
  inline void clear_xcameralist();
  static const int kXCameraListFieldNumber = 1;
  inline const ::FS::CameraControlEvents_Camera& xcameralist(int index) const;
  inline ::FS::CameraControlEvents_Camera* mutable_xcameralist(int index);
  inline ::FS::CameraControlEvents_Camera* add_xcameralist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::CameraControlEvents_Camera >&
      xcameralist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::CameraControlEvents_Camera >*
      mutable_xcameralist();

  // @@protoc_insertion_point(class_scope:FS.CameraControlEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::CameraControlEvents_Camera > xcameralist_;
...
class LIBPROTOC_EXPORT ParticleEvents_Particle : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.ParticleEvents.EPERTYPE Rotation = 3;
  inline bool has_rotation() const;
  inline void clear_rotation();
  static const int kRotationFieldNumber = 3;
  inline ::FS::ParticleEvents_EPERTYPE rotation() const;
  inline void set_rotation(::FS::ParticleEvents_EPERTYPE value);
  ...
  // required .FS.FSVector3 TargetTacheOffest = 6;
  ...
  inline const ::FS::FSVector3& targettacheoffest() const;
  inline ::FS::FSVector3* mutable_targettacheoffest();
  inline ::FS::FSVector3* release_targettacheoffest();
  inline void set_allocated_targettacheoffest(::FS::FSVector3* targettacheoffest);
  ...
  // @@protoc_insertion_point(class_scope:FS.ParticleEvents.Particle)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  ...
  ::FS::FSVector3* targettacheoffest_;
...
class LIBPROTOC_EXPORT ParticleEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.ParticleEvents.Particle xParticleList = 1;
  inline int xparticlelist_size() const;
  inline void clear_xparticlelist();
  static const int kXParticleListFieldNumber = 1;
  inline const ::FS::ParticleEvents_Particle& xparticlelist(int index) const;
  inline ::FS::ParticleEvents_Particle* mutable_xparticlelist(int index);
  inline ::FS::ParticleEvents_Particle* add_xparticlelist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::ParticleEvents_Particle >&
      xparticlelist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::ParticleEvents_Particle >*
      mutable_xparticlelist();

  // @@protoc_insertion_point(class_scope:FS.ParticleEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::ParticleEvents_Particle > xparticlelist_;
...
class LIBPROTOC_EXPORT EnableEvents_Enable : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.EnableEvents.EEETYPE EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::EnableEvents_EEETYPE eventtype() const;
  inline void set_eventtype(::FS::EnableEvents_EEETYPE value);
  ...
  // @@protoc_insertion_point(class_scope:FS.EnableEvents.Enable)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT EnableEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.EnableEvents.Enable xEnableList = 1;
  inline int xenablelist_size() const;
  inline void clear_xenablelist();
  static const int kXEnableListFieldNumber = 1;
  inline const ::FS::EnableEvents_Enable& xenablelist(int index) const;
  inline ::FS::EnableEvents_Enable* mutable_xenablelist(int index);
  inline ::FS::EnableEvents_Enable* add_xenablelist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::EnableEvents_Enable >&
      xenablelist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::EnableEvents_Enable >*
      mutable_xenablelist();

  // @@protoc_insertion_point(class_scope:FS.EnableEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::EnableEvents_Enable > xenablelist_;
...
class LIBPROTOC_EXPORT TrailEvents_Trail : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.TrailEvents.TEETYPE EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::TrailEvents_TEETYPE eventtype() const;
  inline void set_eventtype(::FS::TrailEvents_TEETYPE value);
  ...
  // @@protoc_insertion_point(class_scope:FS.TrailEvents.Trail)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT TrailEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.TrailEvents.Trail xTrailList = 1;
  inline int xtraillist_size() const;
  inline void clear_xtraillist();
  static const int kXTrailListFieldNumber = 1;
  inline const ::FS::TrailEvents_Trail& xtraillist(int index) const;
  inline ::FS::TrailEvents_Trail* mutable_xtraillist(int index);
  inline ::FS::TrailEvents_Trail* add_xtraillist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::TrailEvents_Trail >&
      xtraillist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::TrailEvents_Trail >*
      mutable_xtraillist();

  // @@protoc_insertion_point(class_scope:FS.TrailEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::TrailEvents_Trail > xtraillist_;
...
class LIBPROTOC_EXPORT AudioEvents_Audio : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.AudioEvents.AEETYPE EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::AudioEvents_AEETYPE eventtype() const;
  inline void set_eventtype(::FS::AudioEvents_AEETYPE value);
  ...
  // @@protoc_insertion_point(class_scope:FS.AudioEvents.Audio)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT AudioEvents : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.AudioEvents.Audio xAudioList = 1;
  inline int xaudiolist_size() const;
  inline void clear_xaudiolist();
  static const int kXAudioListFieldNumber = 1;
  inline const ::FS::AudioEvents_Audio& xaudiolist(int index) const;
  inline ::FS::AudioEvents_Audio* mutable_xaudiolist(int index);
  inline ::FS::AudioEvents_Audio* add_xaudiolist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::AudioEvents_Audio >&
      xaudiolist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::AudioEvents_Audio >*
      mutable_xaudiolist();

  // @@protoc_insertion_point(class_scope:FS.AudioEvents)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::AudioEvents_Audio > xaudiolist_;
...
class LIBPROTOC_EXPORT GlobalSpeeds_Speed : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.GlobalSpeeds.EGSTYPE EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::GlobalSpeeds_EGSTYPE eventtype() const;
  inline void set_eventtype(::FS::GlobalSpeeds_EGSTYPE value);
  ...
  // @@protoc_insertion_point(class_scope:FS.GlobalSpeeds.Speed)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT GlobalSpeeds : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.GlobalSpeeds.Speed xSpeedList = 1;
  inline int xspeedlist_size() const;
  inline void clear_xspeedlist();
  static const int kXSpeedListFieldNumber = 1;
  inline const ::FS::GlobalSpeeds_Speed& xspeedlist(int index) const;
  inline ::FS::GlobalSpeeds_Speed* mutable_xspeedlist(int index);
  inline ::FS::GlobalSpeeds_Speed* add_xspeedlist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::GlobalSpeeds_Speed >&
      xspeedlist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::GlobalSpeeds_Speed >*
      mutable_xspeedlist();

  // @@protoc_insertion_point(class_scope:FS.GlobalSpeeds)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::GlobalSpeeds_Speed > xspeedlist_;
...
class LIBPROTOC_EXPORT AnimatorFlys_Fly : public ::google::protobuf::Message {
 public:
  ...
  // required .FS.AnimatorFlys.EAFType EventType = 2;
  inline bool has_eventtype() const;
  inline void clear_eventtype();
  static const int kEventTypeFieldNumber = 2;
  inline ::FS::AnimatorFlys_EAFType eventtype() const;
  inline void set_eventtype(::FS::AnimatorFlys_EAFType value);
  ...
  // @@protoc_insertion_point(class_scope:FS.AnimatorFlys.Fly)
 private:
  inline void set_has_eventtime();
  inline void clear_has_eventtime();
  inline void set_has_eventtype();
...
class LIBPROTOC_EXPORT AnimatorFlys : public ::google::protobuf::Message {
 public:
  ...
  // repeated .FS.AnimatorFlys.Fly xFlyList = 1;
  inline int xflylist_size() const;
  inline void clear_xflylist();
  static const int kXFlyListFieldNumber = 1;
  inline const ::FS::AnimatorFlys_Fly& xflylist(int index) const;
  inline ::FS::AnimatorFlys_Fly* mutable_xflylist(int index);
  inline ::FS::AnimatorFlys_Fly* add_xflylist();
  inline const ::google::protobuf::RepeatedPtrField< ::FS::AnimatorFlys_Fly >&
      xflylist() const;
  inline ::google::protobuf::RepeatedPtrField< ::FS::AnimatorFlys_Fly >*
      mutable_xflylist();

  // @@protoc_insertion_point(class_scope:FS.AnimatorFlys)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::FS::AnimatorFlys_Fly > xflylist_;
...
inline ::FS::SuwayyahEvents_ESEType SuwayyahEvents_Suwayyah::eventtype() const {
  return static_cast< ::FS::SuwayyahEvents_ESEType >(eventtype_);
}
inline void SuwayyahEvents_Suwayyah::set_eventtype(::FS::SuwayyahEvents_ESEType value) {
  assert(::FS::SuwayyahEvents_ESEType_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::SuwayyahEvents_Suwayyah& SuwayyahEvents::xsuwayyahlist(int index) const {
  return xsuwayyahlist_.Get(index);
}
inline ::FS::SuwayyahEvents_Suwayyah* SuwayyahEvents::mutable_xsuwayyahlist(int index) {
  return xsuwayyahlist_.Mutable(index);
}
inline ::FS::SuwayyahEvents_Suwayyah* SuwayyahEvents::add_xsuwayyahlist() {
...
inline ::FS::BulletEvents_EBEType BulletEvents_Bullet::eventtype() const {
  return static_cast< ::FS::BulletEvents_EBEType >(eventtype_);
}
inline void BulletEvents_Bullet::set_eventtype(::FS::BulletEvents_EBEType value) {
  assert(::FS::BulletEvents_EBEType_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline ::FS::BulletEvents_EBE_BACKType BulletEvents_Bullet::bulletbacktype() const {
  return static_cast< ::FS::BulletEvents_EBE_BACKType >(bulletbacktype_);
}
inline void BulletEvents_Bullet::set_bulletbacktype(::FS::BulletEvents_EBE_BACKType value) {
  assert(::FS::BulletEvents_EBE_BACKType_IsValid(value));
...
inline void BulletEvents_Bullet::clear_firetacheoffest() {
  if (firetacheoffest_ != NULL) firetacheoffest_->::FS::FSVector3::Clear();
  clear_has_firetacheoffest();
}
inline const ::FS::FSVector3& BulletEvents_Bullet::firetacheoffest() const {
  return firetacheoffest_ != NULL ? *firetacheoffest_ : *default_instance_->firetacheoffest_;
}
inline ::FS::FSVector3* BulletEvents_Bullet::mutable_firetacheoffest() {
  set_has_firetacheoffest();
  if (firetacheoffest_ == NULL) firetacheoffest_ = new ::FS::FSVector3;
  return firetacheoffest_;
}
inline ::FS::FSVector3* BulletEvents_Bullet::release_firetacheoffest() {
  clear_has_firetacheoffest();
  ::FS::FSVector3* temp = firetacheoffest_;
  firetacheoffest_ = NULL;
  return temp;
}
inline void BulletEvents_Bullet::set_allocated_firetacheoffest(::FS::FSVector3* firetacheoffest) {
...
inline const ::FS::BulletEvents_TacheBomp& BulletEvents_Bullet::bomp(int index) const {
  return bomp_.Get(index);
}
inline ::FS::BulletEvents_TacheBomp* BulletEvents_Bullet::mutable_bomp(int index) {
  return bomp_.Mutable(index);
}
inline ::FS::BulletEvents_TacheBomp* BulletEvents_Bullet::add_bomp() {
  return bomp_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::FS::BulletEvents_TacheBomp >&
...
inline const ::FS::BulletEvents_Bullet& BulletEvents::xbulletlist(int index) const {
  return xbulletlist_.Get(index);
}
inline ::FS::BulletEvents_Bullet* BulletEvents::mutable_xbulletlist(int index) {
  return xbulletlist_.Mutable(index);
}
inline ::FS::BulletEvents_Bullet* BulletEvents::add_xbulletlist() {
...
inline ::FS::AnimatorMoves_EAMType AnimatorMoves_Move::eventtype() const {
  return static_cast< ::FS::AnimatorMoves_EAMType >(eventtype_);
}
inline void AnimatorMoves_Move::set_eventtype(::FS::AnimatorMoves_EAMType value) {
  assert(::FS::AnimatorMoves_EAMType_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::AnimatorMoves_Move& AnimatorMoves::xmovelist(int index) const {
  return xmovelist_.Get(index);
}
inline ::FS::AnimatorMoves_Move* AnimatorMoves::mutable_xmovelist(int index) {
  return xmovelist_.Mutable(index);
}
inline ::FS::AnimatorMoves_Move* AnimatorMoves::add_xmovelist() {
...
inline ::FS::CameraControlEvents_ECEType CameraControlEvents_Camera::eventtype() const {
  return static_cast< ::FS::CameraControlEvents_ECEType >(eventtype_);
}
inline void CameraControlEvents_Camera::set_eventtype(::FS::CameraControlEvents_ECEType value) {
  assert(::FS::CameraControlEvents_ECEType_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline void CameraControlEvents_Camera::clear_amountparam() {
  if (amountparam_ != NULL) amountparam_->::FS::FSVector3::Clear();
  clear_has_amountparam();
}
inline const ::FS::FSVector3& CameraControlEvents_Camera::amountparam() const {
  return amountparam_ != NULL ? *amountparam_ : *default_instance_->amountparam_;
}
inline ::FS::FSVector3* CameraControlEvents_Camera::mutable_amountparam() {
  set_has_amountparam();
  if (amountparam_ == NULL) amountparam_ = new ::FS::FSVector3;
  return amountparam_;
}
inline ::FS::FSVector3* CameraControlEvents_Camera::release_amountparam() {
  clear_has_amountparam();
  ::FS::FSVector3* temp = amountparam_;
  amountparam_ = NULL;
  return temp;
}
inline void CameraControlEvents_Camera::set_allocated_amountparam(::FS::FSVector3* amountparam) {
  delete amountparam_;
...
inline const ::FS::CameraControlEvents_Camera& CameraControlEvents::xcameralist(int index) const {
  return xcameralist_.Get(index);
}
inline ::FS::CameraControlEvents_Camera* CameraControlEvents::mutable_xcameralist(int index) {
  return xcameralist_.Mutable(index);
}
inline ::FS::CameraControlEvents_Camera* CameraControlEvents::add_xcameralist() {
...
inline ::FS::ParticleEvents_EPERTYPE ParticleEvents_Particle::rotation() const {
  return static_cast< ::FS::ParticleEvents_EPERTYPE >(rotation_);
}
inline void ParticleEvents_Particle::set_rotation(::FS::ParticleEvents_EPERTYPE value) {
  assert(::FS::ParticleEvents_EPERTYPE_IsValid(value));
  set_has_rotation();
  rotation_ = value;
}
...
inline void ParticleEvents_Particle::clear_targettacheoffest() {
  if (targettacheoffest_ != NULL) targettacheoffest_->::FS::FSVector3::Clear();
  clear_has_targettacheoffest();
}
inline const ::FS::FSVector3& ParticleEvents_Particle::targettacheoffest() const {
  return targettacheoffest_ != NULL ? *targettacheoffest_ : *default_instance_->targettacheoffest_;
}
inline ::FS::FSVector3* ParticleEvents_Particle::mutable_targettacheoffest() {
  set_has_targettacheoffest();
  if (targettacheoffest_ == NULL) targettacheoffest_ = new ::FS::FSVector3;
  return targettacheoffest_;
}
inline ::FS::FSVector3* ParticleEvents_Particle::release_targettacheoffest() {
  clear_has_targettacheoffest();
  ::FS::FSVector3* temp = targettacheoffest_;
  targettacheoffest_ = NULL;
  return temp;
}
inline void ParticleEvents_Particle::set_allocated_targettacheoffest(::FS::FSVector3* targettacheoffest) {
...
inline const ::FS::ParticleEvents_Particle& ParticleEvents::xparticlelist(int index) const {
  return xparticlelist_.Get(index);
}
inline ::FS::ParticleEvents_Particle* ParticleEvents::mutable_xparticlelist(int index) {
  return xparticlelist_.Mutable(index);
}
inline ::FS::ParticleEvents_Particle* ParticleEvents::add_xparticlelist() {
...
inline ::FS::EnableEvents_EEETYPE EnableEvents_Enable::eventtype() const {
  return static_cast< ::FS::EnableEvents_EEETYPE >(eventtype_);
}
inline void EnableEvents_Enable::set_eventtype(::FS::EnableEvents_EEETYPE value) {
  assert(::FS::EnableEvents_EEETYPE_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::EnableEvents_Enable& EnableEvents::xenablelist(int index) const {
  return xenablelist_.Get(index);
}
inline ::FS::EnableEvents_Enable* EnableEvents::mutable_xenablelist(int index) {
  return xenablelist_.Mutable(index);
}
inline ::FS::EnableEvents_Enable* EnableEvents::add_xenablelist() {
...
inline ::FS::TrailEvents_TEETYPE TrailEvents_Trail::eventtype() const {
  return static_cast< ::FS::TrailEvents_TEETYPE >(eventtype_);
}
inline void TrailEvents_Trail::set_eventtype(::FS::TrailEvents_TEETYPE value) {
  assert(::FS::TrailEvents_TEETYPE_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::TrailEvents_Trail& TrailEvents::xtraillist(int index) const {
  return xtraillist_.Get(index);
}
inline ::FS::TrailEvents_Trail* TrailEvents::mutable_xtraillist(int index) {
  return xtraillist_.Mutable(index);
}
inline ::FS::TrailEvents_Trail* TrailEvents::add_xtraillist() {
...
inline ::FS::AudioEvents_AEETYPE AudioEvents_Audio::eventtype() const {
  return static_cast< ::FS::AudioEvents_AEETYPE >(eventtype_);
}
inline void AudioEvents_Audio::set_eventtype(::FS::AudioEvents_AEETYPE value) {
  assert(::FS::AudioEvents_AEETYPE_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::AudioEvents_Audio& AudioEvents::xaudiolist(int index) const {
  return xaudiolist_.Get(index);
}
inline ::FS::AudioEvents_Audio* AudioEvents::mutable_xaudiolist(int index) {
  return xaudiolist_.Mutable(index);
}
inline ::FS::AudioEvents_Audio* AudioEvents::add_xaudiolist() {
...
inline ::FS::GlobalSpeeds_EGSTYPE GlobalSpeeds_Speed::eventtype() const {
  return static_cast< ::FS::GlobalSpeeds_EGSTYPE >(eventtype_);
}
inline void GlobalSpeeds_Speed::set_eventtype(::FS::GlobalSpeeds_EGSTYPE value) {
  assert(::FS::GlobalSpeeds_EGSTYPE_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::GlobalSpeeds_Speed& GlobalSpeeds::xspeedlist(int index) const {
  return xspeedlist_.Get(index);
}
inline ::FS::GlobalSpeeds_Speed* GlobalSpeeds::mutable_xspeedlist(int index) {
  return xspeedlist_.Mutable(index);
}
inline ::FS::GlobalSpeeds_Speed* GlobalSpeeds::add_xspeedlist() {
...
inline ::FS::AnimatorFlys_EAFType AnimatorFlys_Fly::eventtype() const {
  return static_cast< ::FS::AnimatorFlys_EAFType >(eventtype_);
}
inline void AnimatorFlys_Fly::set_eventtype(::FS::AnimatorFlys_EAFType value) {
  assert(::FS::AnimatorFlys_EAFType_IsValid(value));
  set_has_eventtype();
  eventtype_ = value;
}
...
inline const ::FS::AnimatorFlys_Fly& AnimatorFlys::xflylist(int index) const {
  return xflylist_.Get(index);
}
inline ::FS::AnimatorFlys_Fly* AnimatorFlys::mutable_xflylist(int index) {
  return xflylist_.Mutable(index);
}
inline ::FS::AnimatorFlys_Fly* AnimatorFlys::add_xflylist() {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::SuwayyahEvents_ESEType>() {
  return ::FS::SuwayyahEvents_ESEType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::BulletEvents_EBEType>() {
  return ::FS::BulletEvents_EBEType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::BulletEvents_EBE_BACKType>() {
  return ::FS::BulletEvents_EBE_BACKType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::AnimatorMoves_EAMType>() {
  return ::FS::AnimatorMoves_EAMType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::CameraControlEvents_ECEType>() {
  return ::FS::CameraControlEvents_ECEType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::ParticleEvents_EPERTYPE>() {
  return ::FS::ParticleEvents_EPERTYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::EnableEvents_EEETYPE>() {
  return ::FS::EnableEvents_EEETYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::TrailEvents_TEETYPE>() {
  return ::FS::TrailEvents_TEETYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::AudioEvents_AEETYPE>() {
  return ::FS::AudioEvents_AEETYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::GlobalSpeeds_EGSTYPE>() {
  return ::FS::GlobalSpeeds_EGSTYPE_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::FS::AnimatorFlys_EAFType>() {
  return ::FS::AnimatorFlys_EAFType_descriptor();
}
...
#endif  // PROTOBUF_FleetingDefine_2eproto__INCLUDED
