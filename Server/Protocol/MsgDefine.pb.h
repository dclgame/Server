...
void LIBPROTOC_EXPORT protobuf_AddDesc_MsgDefine_2eproto();
...
enum EGameMsgID {
  ...
  EGMI_REQ_OPR_GUILDIO = 1310,
  EGMI_ACK_OPR_GUILDIO = 1311,
  EGMI_REQ_GUILDECTYPEIO = 1312,
  EGMI_ACK_GUILDECTYPEIO = 1313,
  EGMI_SET_GUILDECTYPEIO = 1314,
  ...
  EGMI_REQ_MAP_GRID_IO = 1900,
  EGMI_ACK_MAP_GRID_IO = 1901,
  EGMI_REQ_BIG_MAP_IO = 1902,
  EGMI_ACK_BIG_MAP_IO = 1903,
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameEventCode>() {
  return ::Msg::EGameEventCode_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ESynMsgID>() {
  return ::Msg::ESynMsgID_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameMsgID>() {
  return ::Msg::EGameMsgID_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ESkillType>() {
  return ::Msg::ESkillType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EItemType>() {
  return ::Msg::EItemType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameEquipSubType>() {
  return ::Msg::EGameEquipSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameGemSubType>() {
  return ::Msg::EGameGemSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameItemSubType>() {
  return ::Msg::EGameItemSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameCardSubType>() {
  return ::Msg::EGameCardSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameTokenSubType>() {
  return ::Msg::EGameTokenSubType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameItemExpiredType>() {
  return ::Msg::EGameItemExpiredType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EDrawDropItemState>() {
  return ::Msg::EDrawDropItemState_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGuildPowerType>() {
  return ::Msg::EGuildPowerType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ETaskState>() {
  return ::Msg::ETaskState_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ETaskType>() {
  return ::Msg::ETaskType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EBattleType>() {
  return ::Msg::EBattleType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EShopType>() {
  return ::Msg::EShopType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ERankType>() {
  return ::Msg::ERankType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::ENPCType>() {
  return ::Msg::ENPCType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EPropertyType>() {
  return ::Msg::EPropertyType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Msg::EGameElementType>() {
  return ::Msg::EGameElementType_descriptor();
}
